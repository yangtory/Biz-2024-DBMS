...
INSERT INTO tbl_iolist(io_date,io_time,io_pname,io_dname,io_dceo,io_div,io_quan,io_iprice,io_oprice)
VALUES
...
SELECT * FROM tbl_iolist LIMIT 3 OFFSET 10;

/*
2023년 02월 01일 이전의 데이터만 보여주기
io_date 칼럼은 문자열형 데이터이지만
...
-- 거래구분(io_div)이 2이고
-- 거래수량이(io_quan) 50개 이하인 데이터만 SELECT
SELECT *
FROM tbl_iolist
...
그리고 같은 GROUP 내에서 합계를 합산하여 결과를 보여라
*/
SELECT
	io_pname AS 상품명,
...
FROM tbl_iolist
GROUP BY io_pname; -- 상품명이 같으면 그룹으로 묶어
